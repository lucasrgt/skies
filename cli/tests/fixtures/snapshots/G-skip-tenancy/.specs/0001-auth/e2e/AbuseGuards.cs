...
public class AbuseGuards
{
    ...
    [Fact(DisplayName = "FM-10: past the permitted attempts, login answers 429 with the platform error and a retry window")]
    ...
    [Fact(DisplayName = "FM-12: a registered account's token does not satisfy the app-admin policy; an Admin's does")]
