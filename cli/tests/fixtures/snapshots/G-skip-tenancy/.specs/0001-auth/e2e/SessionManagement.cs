...
public class SessionManagement
{
    ...
    [Fact(DisplayName = "FM-17: the list shows each live family once, flags the current one, and hides expired slots")]
    ...
    [Fact(DisplayName = "FM-18: revoking one of my sessions ends it and leaves the current one")]
    ...
    [Fact(DisplayName = "FM-19: another user's session is not found and stays alive")]
    ...
    [Fact(DisplayName = "FM-20: signing out everywhere else keeps the current session and nobody else's")]
