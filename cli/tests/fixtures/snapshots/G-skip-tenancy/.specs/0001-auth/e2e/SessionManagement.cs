...
public class SessionManagement
{
    ...
    [Fact(DisplayName = "FM-14: the list shows each live family once, flags the current one, and hides expired slots")]
    ...
    [Fact(DisplayName = "FM-15: revoking one of my sessions ends it and leaves the current one")]
    ...
    [Fact(DisplayName = "FM-16: another user's session is not found and stays alive")]
    ...
    [Fact(DisplayName = "FM-17: signing out everywhere else keeps the current session and nobody else's")]
