...
public class CookieDelivery
{
    ...
    [Fact(DisplayName = "FM-18: a web login sets an httpOnly refresh cookie and keeps the token out of the body")]
    ...
    [Fact(DisplayName = "FM-19: a web refresh reads the cookie with no body and reissues it")]
