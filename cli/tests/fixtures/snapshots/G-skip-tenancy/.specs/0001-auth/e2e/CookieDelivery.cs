...
public class CookieDelivery
{
    ...
    [Fact(DisplayName = "FM-23: a web login sets an httpOnly refresh cookie and keeps the token out of the body")]
    ...
    [Fact(DisplayName = "FM-24: a web refresh reads the cookie with no body and reissues it")]
