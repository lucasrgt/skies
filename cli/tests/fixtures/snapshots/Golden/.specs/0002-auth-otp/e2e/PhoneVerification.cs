...
public class PhoneVerification
{
    ...
    /// <summary>Reads the code at the end of the SMS body ("Your Golden code is 123456" becomes "123456").</summary>
    ...
    [Fact(DisplayName = "FM-1: the code from the SMS verifies the phone and completes registration")]
    ...
    [Fact(DisplayName = "FM-2: a wrong code is rejected, verifies nothing, and leaves the real code usable")]
    ...
    [Fact(DisplayName = "FM-3: after five wrong codes the real code no longer verifies")]
