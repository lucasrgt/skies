...
{
    [Fact(DisplayName = "FM-29: local providers cannot start in Production")]
    public void Production_requires_configuration() => CannotStart("Production");

    [Fact(DisplayName = "FM-29: local providers cannot start in Staging")]
    ...
    [Fact(DisplayName = "FM-30: outside Development the app refuses to start without a signing secret of its own")]
