...
public class CookieDelivery
{
    ...
    [Fact(DisplayName = "FM-28: a web login sets an httpOnly refresh cookie and keeps the token out of the body")]
    ...
    [Fact(DisplayName = "FM-29: a web refresh reads the cookie with no body and reissues it")]
