...
public class CookieDelivery
{
    ...
    [Fact(DisplayName = "FM-25: a web login sets an httpOnly refresh cookie and keeps the token out of the body")]
    ...
    [Fact(DisplayName = "FM-26: a web refresh reads the cookie with no body and reissues it")]
