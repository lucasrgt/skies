...
{
    /// <summary>May change app-wide data: the rows every org shares (an entity that is not <c>ITenantScoped</c>).
    /// Held by a user with the <c>Admin</c> role, which registration never grants; the operator assigns it.</summary>
