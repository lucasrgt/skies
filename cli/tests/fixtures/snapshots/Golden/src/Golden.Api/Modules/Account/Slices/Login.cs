...
#pragma warning disable SKY0030 // sign-in has no org yet: the org is read off the found user and put into the JWT
            .IgnoreQueryFilters()
#pragma warning restore SKY0030
    ...
    private static IResult Respond(Result<Output> result, HttpContext http, RefreshCookie cookies)
    {
        ...
        var o = result.Value;
        return cookies.Deliver(http, o.RefreshToken, o, new { o.AccessToken, o.Step, o.Role });
    }
}
